    ...
    <div className="min-h-screen w-full flex" style={{ background: COLORS.paper, fontFamily: "'Inter', sans-serif" }}>
      ...
      <main className="flex-1 p-5 md:p-10 pb-20 md:pb-10 max-w-5xl mx-auto w-full">
        ...
        {tab === "dossiers" && role === "directeur" && (
          <StudentDossiersView students={yearStudents} onEdit={(s) => { setEditingStudent(s); setModal("student"); }} />
        )}
...
function StudentDossiersView({ students, onEdit }) {
  const { t } = useLang();
  const [search, setSearch] = useState("");
  ...
  return (
    <div>
      <h1 className="text-3xl font-extrabold mb-1" style={{ fontFamily: "'Manrope', sans-serif", color: COLORS.ink }}>{t("nav_dossiers")}</h1>
