...
function MainApp({ profile, refreshProfile }) {
  ...
  return (
    <div className="min-h-screen w-full flex" style={{ background: COLORS.paper, fontFamily: "'Inter', sans-serif" }}>
      ...
      {modal === "student" && <StudentModal levels={levels} student={editingStudent} existingClassNames={existingClassNames} tuitionFees={tuitionFees} onClose={() => { setModal(null); setEditingStudent(null); }} onSave={addStudent} onUpdate={updateStudent} />}
...
// ---------- Modals ----------
function StudentModal({ levels, student, existingClassNames, tuitionFees, onClose, onSave, onUpdate }) {
  const { t } = useLang();
