...
function MainApp({ profile }) {
  ...
  const loadAll = useCallback(async () => {
    const [s, p, l, h, a, par, exp, gr, rel, staff, sp, rem] = await Promise.all([
  ...
  const NAV = {
    fondateur: [["dashboard", "Tableau de bord", LayoutDashboard], ["announcements", "Annonces", Megaphone], ["remarks", "Remarques parents", MessageSquare], ["students", "Élèves", Users], ["expenses", "Dépenses", Receipt], ["staff", "Personnel", Wallet], ["lessons", "Devoirs", BookOpen], ["grades", "Notes", ClipboardList], ["mysalary", "Mon salaire", Receipt]],
    ...
    enseignant: [["lessons", "Devoirs", BookOpen], ["grades", "Notes", ClipboardList], ["students", "Élèves", Users], ["mysalary", "Mon salaire", Receipt]],
