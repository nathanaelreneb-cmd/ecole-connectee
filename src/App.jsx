      ...
      {classStudents.length === 0 ? (
        ...
        <>
          {activeCell.studentId && activeCell.subject && (
            <div
              className="fixed left-1/2 z-[60] px-4 py-2.5 rounded-full shadow-lg flex items-center gap-2 text-sm font-semibold"
              style={{ bottom: "max(env(safe-area-inset-bottom, 0px), 12px)", transform: "translateX(-50%)", background: COLORS.ink, color: "#fff", maxWidth: "92vw" }}
            >
