  ...
  return (
    <div className="min-h-screen w-full flex" style={{ background: COLORS.paper, fontFamily: "'Inter', sans-serif" }}>
      ...
      <main className="flex-1 p-5 md:p-10 pb-20 md:pb-10 max-w-5xl mx-auto w-full">
        {tab === "dashboard" && role === "parent" && <ParentChildrenView children={myChildren} paidByStudent={paidByStudent} currency={currency} payments={payments} />}
...
function ParentChildrenView({ children, paidByStudent, currency, payments }) {
  return (
    <div>
