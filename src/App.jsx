...
import {
  ...
  Wallet, TrendingUp, AlertTriangle, BookOpen, FileSpreadsheet, Smartphone, TrendingDown, Receipt, Shield, ClipboardList, ArrowDownWideNarrow, MessageSquare, Menu, CalendarCheck, Languages, Share2, Banknote, Contact, BookMarked, QrCode, Eye, EyeOff, Sparkles, Package, Coins, Download, Printer, ArrowLeft, ArrowRight, Star, ArrowRightLeft, CreditCard, Image as ImageIcon, Camera, ChevronDown, IdCard, Landmark, Settings, CalendarClock, CalendarDays, UserCheck, ListChecks,
} from "lucide-react";
...
function MainApp({ profile, refreshProfile, userEmail }) {
  ...
  const NAV = {
    ...
    enseignant: isSecondaire
      ? [["grades", t("nav_grades"), ClipboardList], ["myassignments", t("nav_my_assignments"), ListChecks], ["attendance", t("nav_attendance"), UserCheck], ["lessonai", t("nav_lesson_ai"), Sparkles], ["lessons", t("nav_lessons"), BookOpen], ["discipline", t("nav_discipline"), AlertTriangle], ["timetable", t("nav_timetable"), CalendarClock], ["weeklyjournal", t("nav_weekly_journal"), BookMarked], ["students", t("nav_students"), Users], ["mysalary", t("nav_my_salary"), Banknote], ["calendar", t("nav_calendar"), CalendarDays]]
