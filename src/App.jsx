...
function MyProfileModal({ profile, onClose, onSave, onUploadAvatar, onUploadSignature }) {
  ...
  const pickAvatar = async (file) => {
    // On force le renouvellement des deux boutons (galerie + appareil photo) à chaque tentative,
    // pour éviter qu'ils restent "bloqués" après un premier usage sur certains téléphones Android.
