...
import {
  ...
  Wallet, TrendingUp, AlertTriangle, BookOpen, FileSpreadsheet, Smartphone, TrendingDown, Receipt, Shield, ClipboardList, ArrowDownWideNarrow, MessageSquare, Menu,
} from "lucide-react";
...
function MainApp({ profile }) {
  ...
  const NAV = {
    ...
    enseignant: [["lessons", "Devoirs", BookOpen], ["grades", "Notes", ClipboardList], ["attendance", "Présences", ClipboardList], ["students", "Élèves", Users], ["mysalary", "Mon salaire", Receipt]],
  ...
  return (
    <div className="min-h-screen w-full flex" style={{ background: COLORS.paper, fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-40 flex justify-around py-2 border-t" style={{ background: COLORS.card, borderColor: COLORS.line }}>
        ...
        <button onClick={() => setShowMoreMenu(true)} className="p-2 rounded-lg" style={{ color: COLORS.inkSoft }}><Menu size={20} /></button>
      </div>
