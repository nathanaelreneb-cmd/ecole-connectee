        ...
        <div className="space-y-2 mb-4">
          {SUBSCRIPTION_TIERS.map((tr) => (
            ...
            >
              ...
              <span className="text-sm font-bold" style={{ fontFamily: "'IBM Plex Mono', monospace" }}>{fmt(tr.price, "GNF")}</span>
            </button>
          ))}
        </div>
