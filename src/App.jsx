...
function MainApp({ profile }) {
  ...
  const loadAll = useCallback(async () => {
    const [s, p, l, h, a, par, exp, gr, rel, staff, sp] = await Promise.all([
  ...
  const NAV = {
    fondateur: [["dashboard", "Tableau de bord", LayoutDashboard], ["announcements", "Annonces", Megaphone], ["students", "Élèves", Users], ["expenses", "Dépenses", Receipt], ["staff", "Personnel", Wallet], ["lessons", "Devoirs", BookOpen], ["grades", "Notes", ClipboardList], ["mysalary", "Mon salaire", Receipt]],
