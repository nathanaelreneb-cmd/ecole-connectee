...
import {
  ...
  Wallet, TrendingUp, AlertTriangle, BookOpen, FileSpreadsheet, Smartphone, TrendingDown, Receipt, Shield, ClipboardList, ArrowDownWideNarrow, MessageSquare,
} from "lucide-react";
...
function MainApp({ profile }) {
  ...
  const NAV = {
    fondateur: [["dashboard", "Tableau de bord", LayoutDashboard], ["announcements", "Annonces", Megaphone], ["remarks", "Remarques parents", MessageSquare], ["students", "Élèves", Users], ["attendance", "Présences", ClipboardList], ["expenses", "Dépenses", Receipt], ["staff", "Personnel", Wallet], ["lessons", "Devoirs", BookOpen], ["grades", "Notes", ClipboardList], ["mysalary", "Mon salaire", Receipt]],
    comptable: [["students", "Élèves & Paiements", Users], ["expenses", "Dépenses", Receipt], ["staff", "Personnel", Wallet], ["mysalary", "Mon salaire", Receipt], ["dashboard", "Statistiques", LayoutDashboard]],
    enseignant: [["attendance", "Présences", ClipboardList], ["lessons", "Devoirs", BookOpen], ["grades", "Notes", ClipboardList], ["students", "Élèves", Users], ["mysalary", "Mon salaire", Receipt]],
    ...
    <div className="min-h-screen w-full flex" style={{ background: COLORS.paper, fontFamily: "'Inter', sans-serif" }}>
      ...
      <main className="flex-1 p-5 md:p-10 pb-20 md:pb-10 max-w-5xl mx-auto w-full">
        ...
        {tab === "expenses" && (role === "comptable" || role === "fondateur") && (
          <ExpensesView expenses={expenses} currency={currency} readOnly={role !== "comptable"} onAdd={() => setModal("expense")} onDelete={deleteExpense} onValidate={validateExpense} />
        )}
...
function ParentChildrenView({ children, paidByStudent, currency, payments, onRelink, grades, attendance }) {
