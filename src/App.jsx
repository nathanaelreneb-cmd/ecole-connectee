      ...
      <div className="rounded-2xl p-5" style={{ background: COLORS.card, border: `1px solid ${COLORS.line}` }}>
        ...
        {!comptable || !comptable.phone ? (
          ...
          <>
            ...
            <a href={`tel:${comptable.phone}`} className="w-full py-2.5 rounded-lg font-semibold flex items-center justify-center gap-2 text-sm" style={{ background: COLORS.paper, color: COLORS.ink }}>
              {t("call_accountant")}
            </a>
          </>
        )}
