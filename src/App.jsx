...
const SUBJECTS_SECONDAIRE = ["Anglais", "Biologie", "Chimie", "ECM", "Économie", "Français", "Géographie", "Géologie", "Histoire", "Mathématiques", "Philosophie", "Physique"];
                  ...
                  {resolvedLevelType === "secondaire" && (
                    <div>
                      ...
                      <select value={subject} onChange={(e) => setSubject(e.target.value)} className="w-full px-3 py-2.5 rounded-lg outline-none" style={inputStyle}>
                        <option value="">—</option>
                        {SUBJECTS_SECONDAIRE.map((s) => <option key={s} value={s}>{s}</option>)}
                      </select>
