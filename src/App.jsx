...
import {
  ...
  Wallet, TrendingUp, AlertTriangle, BookOpen, FileSpreadsheet, Smartphone, TrendingDown, Receipt, Shield, ClipboardList, ArrowDownWideNarrow, MessageSquare, Menu, CalendarCheck, Languages, Share2, Banknote, Contact, BookMarked, QrCode, Eye, EyeOff, Sparkles, Package, Coins, Download, Printer, ArrowLeft, ArrowRight, Star, ArrowRightLeft, CreditCard, Image as ImageIcon, Camera, ChevronDown, IdCard, Landmark, Settings, CalendarClock, CalendarDays, UserCheck,
} from "lucide-react";
...
function MainApp({ profile, refreshProfile, userEmail }) {
  ...
  const { t, lang } = useLang();
  const NAV = {
    fondateur: [["dashboard", t("nav_dashboard"), LayoutDashboard], ["students", t("nav_students"), Users], ["paymentdeclarations", t("nav_payment_declarations"), Smartphone], ["subscriptiondeclare", t("nav_subscription_declare"), Landmark], ["studentcards", t("nav_student_cards"), CreditCard], ["staffcards", t("nav_staff_cards"), IdCard], ["annualbalance", t("nav_annual_balance"), TrendingUp], ["promotion", t("nav_promotion"), ArrowRight], ["filemovements", t("nav_file_movements"), ArrowRightLeft], ["tuitionfees", t("nav_tuition_fees"), Coins], ["schoolsettings", t("nav_school_settings"), Settings], ["services", t("nav_services"), Package], ["attendance", t("nav_attendance"), UserCheck], ["grades", t("nav_grades"), ClipboardList], ["expenses", t("nav_expenses"), Receipt], ["staff", t("nav_staff"), Wallet], ["mysalary", t("nav_my_salary"), Banknote], ["calendar", t("nav_calendar"), CalendarDays]],
    ...
    enseignant: isSecondaire
      ? [["grades", t("nav_grades"), ClipboardList], ["myassignments", t("nav_my_assignments"), BookMarked], ["attendance", t("nav_attendance"), UserCheck], ["lessonai", t("nav_lesson_ai"), Sparkles], ["lessons", t("nav_lessons"), BookOpen], ["discipline", t("nav_discipline"), AlertTriangle], ["timetable", t("nav_timetable"), CalendarClock], ["weeklyjournal", t("nav_weekly_journal"), BookMarked], ["students", t("nav_students"), Users], ["mysalary", t("nav_my_salary"), Banknote], ["calendar", t("nav_calendar"), CalendarDays]]
      : [["grades", t("nav_grades"), ClipboardList], ["attendance", t("nav_attendance"), UserCheck], ["lessonai", t("nav_lesson_ai"), Sparkles], ["lessons", t("nav_lessons"), BookOpen], ["discipline", t("nav_discipline"), AlertTriangle], ["timetable", t("nav_timetable"), CalendarClock], ["weeklyjournal", t("nav_weekly_journal"), BookMarked], ["students", t("nav_students"), Users], ["mysalary", t("nav_my_salary"), Banknote], ["calendar", t("nav_calendar"), CalendarDays]],
    parent: [["dashboard", t("nav_my_children"), GraduationCap], ["revision", t("nav_revision"), Sparkles], ["lessons", t("nav_lessons"), BookOpen], ["timetable", t("nav_timetable"), CalendarClock], ["announcements", t("nav_announcements"), Megaphone], ["remarks", t("nav_my_remarks"), MessageSquare], ["pay", t("nav_pay_remotely"), Smartphone], ["calendar", t("nav_calendar"), CalendarDays]],
    ...
    directeur: [["grades", t("nav_grades"), ClipboardList], ["timetable", t("nav_timetable"), CalendarClock], ["dossiers", t("nav_dossiers"), Contact], ["studentcards", t("nav_student_cards"), CreditCard], ["staffcards", t("nav_staff_cards"), IdCard], ["schoolsettings", t("nav_school_settings"), Settings], ["filemovements", t("nav_file_movements"), ArrowRightLeft], ["weeklyjournal", t("nav_weekly_journal"), BookMarked], ["discipline", t("nav_discipline"), AlertTriangle], ["promotion", t("nav_promotion"), ArrowRight], ["announcements", t("nav_announcements"), Megaphone], ["attendance", t("nav_attendance"), UserCheck], ...(isSecondaire ? [["classteachers", t("nav_head_teachers"), Shield]] : [["classassign", t("nav_class_assign"), Shield]]), ["lessons", t("nav_lessons"), BookOpen], ["mysalary", t("nav_my_salary"), Banknote], ["remarks", t("nav_remarks"), MessageSquare], ["calendar", t("nav_calendar"), CalendarDays]],
  }[role];
